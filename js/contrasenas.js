//Captura para que tener los elementos en los dos sitios
document.addEventListener('DOMContentLoaded', () => {
  const container = document.getElementById('inContrasenas')
  if (!container) return;
  ...
  container.innerHTML = `
    <div class="container-pass">
      ...
      <div class="length-min">
        ...
        <input type="number" id="length-input" class="length-input" min="12" max="50" value="12"/>
